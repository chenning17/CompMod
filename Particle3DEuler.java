...
public class Particle3DEuler  {
	...
	String outFile1 = "euler"+ argv[1] +".data";
	String outFile2 = "energyConEuler"+ argv[1] +".data";
	...
	/*
         * This is the start of the Simpletic Euler algorithm
         */
	...
	/*
	    ...
	    // Update the force constant according to new position
	    F = (G * A.getMass() * B.getMass()) / Math.pow(r.magnitude(),3);
